...
def home(request):
  ...
  data0.append(tmp)
  data0.append({'image':'/static/Enterprise_Information/guangZhouJiuJia/Images/guangZhouJiuJiaLogo.jpg', 'name':'广州酒家', 'describe':'广州酒家于1939年建立， 改革开放后，广州酒家积极开拓连锁经营，企业规模由原来的一间店发展为包括有6间高级酒家、1个大型食品生产基地及30多间连锁食品商场等在内的大型饮食企业集团，总资产与达4亿多元，在行业中位居全国前列。'})
  data0.append({'image':'/static/Enterprise_Information/jiYeJia/Images/jiYeJiaLogo.jpg', 'name':'吉野家', 'describe':'吉野家是一家享有百年历史的著名日本牛肉饭专门店，始创于1899年，在日本筑地鱼市场开设第一间分店。“吉野家”的名字来源于地名，日本的吉野山地区的牛肉饭最为著名，传说是12世纪时候日本名将源义经的爱妾静在掩护义经避难之时，在吉野山把制作牛肉饭的技巧教给了当地居民，于是牛肉饭成为当地的特产美味，“吉野家”之所以这样取名，也是为了说明自己的牛肉饭正宗。'})
...
def myAccount(request):
  ...
  return render_to_response('myAccount.html', {'user': user, 'userInfo':userInfo, 'history':history, 'order':history})
...
def myRestaurant(request):
  ...
  return render_to_response('myRestaurant.html',{'info': info, 'order': order, 'foods': foods, 'user': user})
...
def order(request):
  if request.method == 'POST':
    ...
    if 'id' in request.POST.keys():
      data = {}
      data['orderId'] = request.POST.get('id')
      data['customer'] = 'Raymond'
      data['date'] = '2014-4-8'
      data['detail'] = detail
      data['totalPrice'] = '258'
      ...
      data = {}
      data['orderId'] = '20145013215'
      data['restaurant'] = '四海一家'
      data['date'] = '2014-5-13'
      data['address'] = '广州番禺迎宾路万博中心四海一家'
      data['phone'] = '020-34822266'
      data['detail'] = detail
      data['totalPrice'] = '258'
      return HttpResponse(simplejson.dumps(data, ensure_ascii=False), mimetype='application/json')
    
  return HttpResponse('Get order failed!')
